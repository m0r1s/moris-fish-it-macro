...
Permission is hereby granted to any individual or organization (the "User") to use, copy, and run the Fish It Macro (the "Software") for personal and non-commercial purposes only, under the following terms:
